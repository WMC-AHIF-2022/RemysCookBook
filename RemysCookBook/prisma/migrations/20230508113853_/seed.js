...
async function seed() {
  ...
  const data = fs.readFileSync('migration.sql', 'utf8')

  // Execute the SQL script using the Prisma Client
  await prisma.$executeRaw`insert into recipes values (4929, 'Maki Sushi', '1. Prepare sushi rice: Cook Japanese white rice is mixed with a special sushi rice vinegar. 
